                ...
                <div className="flex flex-col flex-1 p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-5">
                    {project.tags.map((tag, tagIndex) => (
                      <span
                        key={tagIndex}
                        className="inline-block px-2.5 py-0.5 text-[11px] font-sans font-medium
                  ...
                  <div className="flex gap-3">
                    <a
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2
                        ...
                        text-[var(--color-text)] font-sans font-medium text-xs rounded-lg
                    ...
                    <a
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2
                        ...
                        font-sans font-medium text-xs rounded-lg
